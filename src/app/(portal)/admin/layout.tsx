import { BarChart3, CalendarDays, HeartHandshake, LayoutDashboard, Megaphone, School, UserCog, Users, WalletCards } from "lucide-react";
  ...
  return (
    <PortalShell
      ...
      navItems={[
        ...
        { href: "/admin/infaq", label: "Infaq & Tahlil", icon: HeartHandshake },
